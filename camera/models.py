...
from .utils import detect_faces_on_image, detect_eyes_on_image, detect_barcode_on_image, detect_cats_on_image
...
class Image(models.Model):
    ...
    type = models.IntegerField(
        'Type of processing',
        help_text='Choose a proper algorithm.',
